...
%global commit dbd432ecdf46182db391226019e56fa572ae7978
...
# FIXME(chandankumar): https://review.openstack.org/545262 once merged enable docs
%global with_doc 0
...
#Provides:   python-panko-tests >= 4.0.0
#Provides:   python-gnocchi-tests >= 4.2.0
#Provides:   python-aodh-tests >= 6.0.0
#Provides:   python-ceilometer-tests >= 10.0.0
